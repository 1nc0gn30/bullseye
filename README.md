...
The lead generation platform for recruiters tired of wasting time on LinkedIn spam. We guarantee you message the right people.
...
### 📦 Installation
```bash
git clone https://github.com/1nc0gn30/bullseye.git
cd bullseye
npm install
```
...
View your app in AI Studio: https://ai.studio/apps/ff66dbf1-b79b-4f85-ac22-9db2333f21ca
...
## 🔗 Links
- GitHub: https://github.com/1nc0gn30/bullseye
